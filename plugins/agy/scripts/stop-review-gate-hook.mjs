...
function parseStopReviewOutput(rawOutput) {
  ...
  if (!text) {
    return {
      ok: false,
      reason:
        "The stop-time Agy review task returned no final output. Run /agy:review --wait manually or bypass the gate."
    };
  }
  ...
  return {
    ok: false,
    reason:
      "The stop-time Agy review task returned an unexpected answer. Run /agy:review --wait manually or bypass the gate."
  };
}
...
function runStopReview(cwd, input = {}) {
  ...
  if (result.error?.code === "ETIMEDOUT") {
    return {
      ok: false,
      reason:
        "The stop-time Agy review task timed out after 15 minutes. Run /agy:review --wait manually or bypass the gate."
    };
  }
  ...
  try {
    ...
    return {
      ok: false,
      reason:
        "The stop-time Agy review task returned invalid JSON. Run /agy:review --wait manually or bypass the gate."
    };
  }
}
